...
public class Solution {
    ...
    static LocalDateTime changeZone(LocalDateTime fromDateTime, ZoneId fromZone, ZoneId toZone) {
        ZonedDateTime zonedDateTimeNow1 = ZonedDateTime.of(fromDateTime,fromZone);
        LocalDateTime result = zonedDateTimeNow1.withZoneSameInstant(toZone).toLocalDateTime();
//        ZonedDateTime zone2 = ZonedDateTime.of(result, toZone);
//        LocalDateTime res = zone2.toLocalDateTime();
